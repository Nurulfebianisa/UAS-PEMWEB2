...
<button type="submit"><i class="fa fa-search"></i></button>
    ...
    =
                    <center><p>
                        <b>
                            <font size="7">University</font><br>
                    <p>
        ...
        <right> <p>
            ...
            <iframe width="800" height="350" src="https://www.youtube.com/embed/_3G-PYCVuKs" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
        <!-- Image Showcases-->
        <section class="showcase">
            <div class="container-fluid p-0">
                <div class="row g-0">
                    <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('assets/img/ii.jpg')"></div>
                ...
                <div class="row g-0">
                    <div class="col-lg-6 text-white showcase-img" style="background-image: url('assets/img/org.jpg')"></div>
                ...
                <div class="row g-0">
                    <div class="col-lg-6 order-lg-2 text-white showcase-img" style="background-image: url('assets/img/se.jpg')"></div>
                    <div class="col-lg-6 order-lg-1 my-auto showcase-text">
